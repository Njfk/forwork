...
public class Indexdepart1List1Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Indexdepart1List1Adapter(List<Product> productList, Context context) {
    ...
    private static class Index1ViewHolder extends RecyclerView.ViewHolder {
        ...
        public Index1ViewHolder(View itemView) {
            ...
            item_pro_cardview= itemView.findViewById(R.id.item_pro_cardview);
            ViewGroup.LayoutParams layoutParams = item_pro_cardview.getLayoutParams();
            layoutParams.width = ViewGroup.LayoutParams.MATCH_PARENT;
            item_pro_cardview.setLayoutParams(layoutParams);
        }
    }
